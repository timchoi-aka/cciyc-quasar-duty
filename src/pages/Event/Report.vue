...
const fetchStartDate = computed(() =>
  qdate.startOfDate(
    qdate.extractDate(reportStartDate.value, "YYYY/MM/DD"),
    "day"
  )
);
const fetchEndDate = computed(() =>
  qdate.endOfDate(qdate.extractDate(reportEndDate.value, "YYYY/MM/DD"), "day")
);

const { result: AttendanceReport } = useAttendanceReportProvider({
...
const AttendanceData = computed(() => {
  ...
  if (
    ...
    Object.keys(AttendanceReport.value).length > 0
  ) {
