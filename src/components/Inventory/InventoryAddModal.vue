    ...
    <q-card-section>
      ...
      >
        ...
        <div class="col-9 q-my-xs">
          <q-input type="text" v-model="inventoryObject.ID" />
        </div>
        ...
        <div class="col-9 q-my-xs">
          <InventoryLocation
            label="位置"
            v-model="inventoryObject.c_location"
          />
        </div>
        ...
        <div class="col-9 q-my-xs">
          <DateComponent
            label="購買日期"
            v-model="inventoryObject.d_purchase"
          />
        </div>
        <div class="col-3 q-my-xs">金額：</div>
        <div class="col-9 q-my-xs">
          <q-input type="number" v-model="inventoryObject.f_cost" />
        </div>
        ...
        <div class="col-9 q-my-xs">
          <q-input type="number" v-model="inventoryObject.i_qty" />
        </div>
        <q-separator inset />
...
const sourceOfFund = ref(["整筆撥款", "獎券基金", "捐增", "其他資助", "SWDF"]);
  ...
  if (inventoryObject.value.ID) {
    ...
    saveObject.push({
      ...
      d_purchase: inventoryObject.value.d_purchase
        ? qdate.formatDate(
            inventoryObject.value.d_purchase,
            "YYYY-MM-DDT00:00:00"
          )
        : null,
      ...
      d_createDate: qdate.formatDate(new Date(), "YYYY-MM-DDTHH:mm:ss"),
    });
