  ...
  <q-card bordered flat class="q-pa-none q-ma-none text-h6">
    ...
    <q-card-section class="row bg-yellow-2 q-pl-none q-pt-none q-pb-lg">
      ...
      <div class="row col-12 q-gutter-lg q-ml-sm">  
        ...
        <span class="col-3">達標日期: {{Event.d_finish_goal}}</span>
      </div>
      <div class="row col-12 q-gutter-lg q-ml-sm">
    ...
    <q-card-section class="row bg-brown-1 q-pl-none q-pt-none q-pb-lg">
      ...
      <div class="row col-12 q-gutter-lg q-ml-sm">
        ...
        <span class="col-3">合辦機構: <q-icon class="text-green" v-if="Event.b_open_oth" name="check"/><q-icon class="text-red" v-else name="cancel"/></span>
        <span class="col-3">顯示網頁: <q-icon class="text-green" v-if="Event.IsShow" name="check"/><q-icon class="text-red" v-else name="cancel"/></span>
      </div>
    </q-card-section>
    ...
    <q-card-section class="row bg-green-1 q-pl-none q-pt-none q-pb-lg">
      ...
      <div class="row col-12 q-gutter-lg q-ml-sm">
        ...
        <span class="col-11" style="border: 1px solid">{{Event.m_remind_content}}</span>
      </div>
      <div class="row col-12 q-gutter-lg q-ml-sm q-mt-sm q-pb-md">
        <span class="col-11">備註: </span>
        <span class="col-11" style="border: 1px solid">{{Event.m_remark}}</span>
      </div>
    </q-card-section>
  </q-card>
</template>
...
import { DELETE_EVENT_BY_PK } from "/src/graphQueries/Event/mutation.js"
