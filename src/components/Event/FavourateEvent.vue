...
import { ADD_FAVOURATE, REMOVE_FAVOURATE } from "/src/graphQueries/Event/mutation.js";
...
const { mutate: removeFav, onDone: removeFav_Completed } = useMutation(REMOVE_FAVOURATE)

const isFavourate = computed(() => result.value? result.value.Event_Favourate_by_pk? true : false: false)
